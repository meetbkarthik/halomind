...
class _KumbotScreenState extends State<KumbotScreen> {
  ...
  void initState() {
    super.initState();
    _addBotMessage("Hello! I'm Kumbot, your KumindHalo assistant! ✨\n\nI'm here to help you understand how to make the most of your Halo Space and Desire Orbits. Ask me anything!");
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Kumbot Assistant'),
